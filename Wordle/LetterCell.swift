...
class LetterCell: UICollectionViewCell {
    ...
    func set(style: LetterCellStyle) {
        switch style {
        case .initial:
            // initial: background black, border gray
            contentView.backgroundColor = .black
            layer.borderColor = UIColor.gray.cgColor
            
        case .incorrect:
            // incorrect: RGBA (0.23, 0.23, 0.24, 1.0)
        ...
        case .correctLetterOnly:
            // correctLetterOnly: RGBA (0.69, 0.63, 0.30, 1.0)
        ...
        case .correctLetterAndPosition:
            // correctLetterAndPosition: RGBA (0.38, 0.55, 0.33, 1.0)
